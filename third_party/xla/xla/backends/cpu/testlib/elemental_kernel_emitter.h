...
class ElementalKernelEmitter final : public KernelEmitter {
 public:
  ...
  ElementalKernelEmitter(
      ...
      HloOpcode opcode,
      ElementalIrEmitterFactory elemental_ir_emitter_factory =
          &ElementalIrEmitterFactoryForTests);

  absl::StatusOr<std::unique_ptr<KernelSpec>> EmitKernelSpec() override;

 private:
  static std::unique_ptr<ElementalIrEmitter> ElementalIrEmitterFactoryForTests(
  ...
  ElementalIrEmitterFactory elemental_ir_emitter_factory_;
